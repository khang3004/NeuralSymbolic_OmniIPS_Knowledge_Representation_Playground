...
FALLBACK_GEOMETRY_RULES = [
    ...
    {"id": "geo_parallel_corresponding_angles_var", "name": "Parallel Line Corresponding Angles",
     "inputs": ["Parallel(?A?B,?C?D)", "PointOnSegment(?E,?A,?C)"], "outputs": ["Equal(Angle(?E?A?B),Angle(?A?C?D))"],
     "description": "Corresponding angles formed by parallel lines are equal."},
    {"id": "geo_parallel_corresponding_angles_collinear_var", "name": "Parallel Line Corresponding Angles (Collinear)",
     "inputs": ["Parallel(?A?B,?C?D)", "Collinear(?E,?A,?C)"], "outputs": ["Equal(Angle(?E?A?B),Angle(?A?C?D))"],
     "description": "Corresponding angles formed by parallel lines are equal."},
